...
exports.getLocalizedField = function(string, locale = baseLocale) {
  if (locale == baseLocale) {return string; }
  else if (config.KURDISH_LOCALES.includes(locale)) { return `${string}_ku`; }
  else { return `${string}_${locale}` }
}
