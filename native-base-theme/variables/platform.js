...
export default {
  ...
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 14,
  activeTab: platform === PLATFORM.IOS ? '#ff8aef' : '#ff8aef',
  sTabBarActiveTextColor: '#ff8aef',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#ff8aef' : '#ff8aef',
